...
(() => {
  ...
  function multilineText(text, x, y, maxCharsPerLine, lineHeight, attrs){
  ...
  function buildHalfSVG(rect, part){
    ...
    const t = multilineText(txt, HALF_W/2, bandY+18, mobile ? 28 : 24, 14, { "font-size": 11 });
    content.appendChild(t);

    // small stamp
    content.appendChild(svgEl("rect", { x:HALF_W/2-52, y:10, width:104, height:24, rx:8, fill:"none", stroke:"rgba(156,47,47,.55)", "stroke-width":2, opacity:.70 }));
    const st = svgEl("text", { x:HALF_W/2, y:27, "text-anchor":"middle", fill:"rgba(156,47,47,.60)", "font-size":12, "font-weight":900 });
    st.textContent = "SPÉCIAL NOËL";
  ...
  function buildRectSVG(rect, engravedDone){
    ...
    // two lines (termA + termB)
    const t = multilineText(rect.termA, rectW/2, bandY+18, mobile ? 42 : 34, 14, { "font-size": 11 });
    content.appendChild(t);
    const t2 = multilineText(rect.termB, rectW/2, bandY+36, mobile ? 42 : 34, 14, { "font-size": 11, "font-weight": 800, fill:"rgba(0,0,0,.70)" });
    ...
    // seal
    content.appendChild(svgEl("rect", { x:rectW/2-52, y:10, width:104, height:26, rx:8, fill:"none", stroke:"rgba(156,47,47,.70)", "stroke-width":2 }));
    const sealTxt = svgEl("text", { x:rectW/2, y:28, "text-anchor":"middle", fill:"rgba(156,47,47,.70)", "font-size":12, "font-weight":900 });
    sealTxt.textContent = "CALENDRIER — 1908";
